...
const badgeVariants = cva(
  "inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-full px-2 py-0.5 text-[0.625rem] font-medium whitespace-nowrap transition-all before:size-1.5 before:shrink-0 before:rounded-full before:bg-current [&>svg]:pointer-events-none [&>svg]:size-2.5!",
  {
    variants: {
      variant: {
